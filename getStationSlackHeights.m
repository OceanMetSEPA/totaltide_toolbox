function [ dataSeries ] = getStationSlackHeights(station, startDate, numDays)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% $Workfile:   getStationSlackHeights.m  $
% $Revision:   1.1  $
% $Author:   ted.schlicke  $
% $Date:   May 28 2014 12:23:04  $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    % TotalTide.getStationheights() which returns height records at a
    % specified time resolution (mins)
    %
    % Usage:
    % TotalTides.getStationSlackHeights(station, startDate, numDays) 
    %   where 
    %
    ...
    %    tide = TotalTides.getStationSlackHeights(port,'16/05/2006',100)
    %
    % DEPENDENCIES:
    ...
    if nargin==0
      help TotalTide.getStationSlackHeights
      return
    end
    ...
    for i = 1:numberIterations
        ...
        events = station.TidalEvents(days);
